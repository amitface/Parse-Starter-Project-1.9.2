...
public class CustomAdapterSearch extends ParseQueryAdapter<ParseObject> implements View.OnClickListener{



    ParseUser current = ParseUser.getCurrentUser();
    public CustomAdapterSearch(Context context, final List<String> rt) {
