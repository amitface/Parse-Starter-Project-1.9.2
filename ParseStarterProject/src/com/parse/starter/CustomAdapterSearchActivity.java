...
public class CustomAdapterSearchActivity extends ParseQueryAdapter<ParseObject> implements View.OnClickListener,Filterable{
    ...
    public CustomAdapterSearchActivity(Context context) {
